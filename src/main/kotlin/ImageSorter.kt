    ...
    companion object {
        ...
        fun sortByImagePosition(unsortedData: List<TagToDataMap>): List<TagToDataMap> {
            ...
            return unsortedData.sortedBy { data ->
                ...
                val imgPos = (data[imagePositionTag]!!.value as String).trim().split("\\")
                // example imgPos: -110.2841796875\-248.63495760157\-163.23956032249 // x, y, z
                //
                //val imgOr = (data[imageOrientationTag]!!.value as String)
                // example imgOrient: 1\0\0\0\0.96126169593832\-0.275637355817

                imgPos[2].trim().toDouble() // z
            }
        }
    } // companion end
}
